...
/**
 * Servlet implementation class QuestionDown
 */
@WebServlet("/QuestionDown")
public class QuestionDown extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (sessionType == 1 || sessionType == 2) {
				evDatenbank.questionDown(questionid, evDatenbank.getFragebogenreferenzOfFragebogen(evaluationID),
						sessionId);
