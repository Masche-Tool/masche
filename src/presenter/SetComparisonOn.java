...
/**
 * Servlet implementation class SetComparisonOn
 */
@WebServlet("/SetComparisonOn")
public class SetComparisonOn extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SetComparisonOn() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Cookie cookie = new Cookie("masche_show_comparison", "1");
