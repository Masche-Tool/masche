...
/**
 * Servlet implementation class EditEvaluationMetadata
 */
@WebServlet("/EditEvaluationMetadata")
public class EditEvaluationMetadata extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditEvaluationMetadata() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (sessionType == 1 || sessionType == 2) {
				evDatenbank.editEvaluationMeta(sessionId, evaluationID, beschreibung, semester, modulname);
